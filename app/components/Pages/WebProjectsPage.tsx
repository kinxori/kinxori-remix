...
function ElDiablito13({ pageNumber }: { pageNumber: number }) {
  return (
    ...
    >
      <img
        alt='Screenshot of El Diablito Trece landing page website. At the left side of the screen you have the main copy of the landing page. Below that you have 2 call to action buttons. At the right side you have a drawing of a devil smoking a cigar with long hair.'
      ...
      <div className='my-5 flex flex-col gap-5'>
        <div>
          ...
          <h3 className='text-mainColor font-bold text-[20px] text-left'>El Diablito Trece</h3>
        </div>
        <p className='text-[14px] '>
          El Diablito Trece's official website.&#xa0;
          <Link to='/el-diablito-trece-project' className='underline italic text-mainColor '>
            Read more.
          </Link>
        </p>
      ...
      <AnchorButton
        ...
        ariaLabel="Hyperlink to visit El Diablito Trece's official website."
