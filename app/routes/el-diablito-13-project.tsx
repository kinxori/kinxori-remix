      ...
      <div className="  flex-col flex p-10 box-border">
        ...
        <article>
          <div className="text-bgColor box-border p-5 bg-white min-h-[200px] rounded-[10px] border-[2px] border-mainColor ">
            ...
            <Button variant="ghostButton">1. Project Overview</Button>
            <Button variant="ghostButton">2. Brand Identity and Concept</Button>
            <Button variant="ghostButton">3. Features and Functionality</Button>
            <Button variant="ghostButton">4. Design and User Experience</Button>
            <Button variant="ghostButton">5. Technical Implementation</Button>
          </div>
          <div className="my-10">
            ...
            <div className="flex flex-col gap-5 text-justify">
              ...
              <p>
                Meticulously crafting everything, from the branding core to adapting the main theme
                of "El Diablito 13," ensuring a seamless UX/UI design. This involves adhering to
                specific color palettes and font types to maintain a consistent and cohesive aura
            ...
            <div className="flex flex-col gap-5 text-justify">
              ...
              <p>
                A prominent message will be displayed, encouraging users to "Click me." This action
                will load the full website content and cause the Intro Page to disappear.
              </p>
              ...
              <p>
                ...
                navigation bar improves the responsive design and experiece of the user regardles of
                the device they use to explore the website.
              </p>
              ...
              <p>
                ...
                EmailSender library, and Google Auth services. These components collaborate
                seamlessly to establish an email sender, enabling each user to effortlessly
                communicate with the author in an efficient and user-friendly manner.
              </p>
            </div>
            <div className="flex flex-col gap-5 text-justify">
              <h3 className="text-[20px] font-bold text-left ">
            ...
            <div className="flex flex-col gap-5 text-justify">
              ...
              <p>
                ...
                databases or login authentication, it is important to note that this stance doesn't
                preclude the potential incorporation of such features in the near future.
              </p>
              <p>
                Acknowledging the diversity of devices used to access the website, we have embraced
                a responsive design approach. Our commitment to the "Mobile First" methodology has
