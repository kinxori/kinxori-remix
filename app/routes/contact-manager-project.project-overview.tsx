export default function ContactManagerProjectOverview() {
  return (
    <article className="flex flex-col gap-5 text-justify">
      ...
      <p>
        Introducing the Contact Manager Project The "Contact Manager" project was developed as a
        technical test submission for a Junior Frontend Developer role. This React-based application
        showcases the required skills in creating a functional and user-friendly contact management
      ...
      <p>
        ...
        create a practical solution for inarticleiduals seeking an uncomplicated way to manage their
        contacts.
      </p>
      <span>
      ...
      <p>
        ...
        application. The project's purpose is to demonstrate the grasp of React concepts, state
        management, form handling, and user interface design. By developing a functional contact
        management tool, I can showcases my ability to craft real-world applications that are both
        visually appealing and highly usable.
      </p>
      <span>
