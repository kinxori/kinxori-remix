...
export default function DiablitoProjectOverview() {
  return (
    <article className="flex flex-col gap-5 text-justify">
      ...
      <p>
        Focusing on showcasing some of the key art projects developed by 'El Diablito 13,' our
      ...
      <p>
        "El Diablito 13" fosters a lively community for artists to share, collaborate, and amplify
        their creations. This space encourages connections, showcasing work, exchanging insights,
        and nurturing innovation. A global platform igniting friendships, kindling ideas, and
        fueling creativity as diverse voices contribute their artistic flair to a limitless canvas.
      </p>
      <VideoLoader
